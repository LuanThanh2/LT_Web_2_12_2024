...
<li class="list-inline-item"><a href="shop-account.html" class="text-decoration-none">My Account</a></li>
<li class="list-inline-item"><a href="shop-wishlist.html" class="text-decoration-none">My Wishlist</a></li>
<li class="list-inline-item"><a href="shop-checkout.html" class="text-decoration-none">Checkout</a></li>
<!-- Login Form -->
<li class="list-inline-item dropdown">
<a href="#" class="text-decoration-none dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">Login</a>
...
<a href="${pageContext.request.contextPath}/register" class="btn btn-secondary btn-sm mt-2">Register</a>
</div>
</div>
</li>
</ul>
